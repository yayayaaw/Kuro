...
export const CMSDashboard: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#F4F2EC] text-[#161514] font-sans flex flex-col">
      {/* Global Save Toast — selalu tampil di semua ukuran layar */}
      {saveAlert && (
        <div className="fixed bottom-4 left-1/2 -translate-x-1/2 z-50 flex items-center space-x-2 text-xs text-emerald-800 bg-white px-4 py-3 border border-emerald-300 shadow-lg max-w-[92vw]">
      ...
      {/* Top Banner CMS */}
      <header className="bg-[#161514] text-[#F7F5F0] border-b border-[#2A2724] px-4 sm:px-6 py-3.5 sm:py-4 sticky top-0 z-30 flex items-center justify-between gap-2">
        <div className="flex items-center space-x-2.5 sm:space-x-3 min-w-0">
          <div className="w-8 h-8 rounded-sm bg-[#F7F5F0] text-[#161514] flex items-center justify-center font-serif font-bold text-sm shrink-0">
            K
          </div>
          <div className="min-w-0">
            <h1 className="font-serif text-sm sm:text-lg tracking-[0.1em] sm:tracking-[0.15em] uppercase font-normal text-[#F7F5F0] truncate">
              KURO Studio — CMS Admin
            </h1>
            <p className="hidden sm:block text-[10px] tracking-wider text-[#F7F5F0]/60 uppercase font-light">
        ...
        <div className="flex items-center space-x-2 sm:space-x-3 shrink-0">
          <button
            ...
            className="p-2 sm:px-3 sm:py-2 border border-[#F7F5F0]/20 text-[#F7F5F0]/70 text-xs uppercase tracking-wider hover:text-[#F7F5F0] hover:border-[#F7F5F0]/50 transition-colors cursor-pointer"
          ...
          <button
            ...
            className="flex items-center space-x-1.5 px-3.5 sm:px-5 py-2 bg-[#F7F5F0] text-[#161514] text-xs font-semibold tracking-wider uppercase hover:bg-[#E5E1D8] transition-colors cursor-pointer"
          >
            <Save className="w-3.5 h-3.5" />
            <span className="hidden xs:inline sm:inline">Simpan Semua</span>
          </button>
        </div>
      </header>

      {/* Main CMS Workspace */}
      <div className="flex-1 max-w-7xl w-full mx-auto p-3 sm:p-8 grid grid-cols-1 md:grid-cols-12 gap-4 sm:gap-8 items-start">

        {/* Left Sidebar Navigation — pill scroll di mobile, list di desktop */}
        <aside className="md:col-span-3 bg-[#F7F5F0] border border-[#161514]/15 p-3 text-left md:sticky md:top-24">
          <div className="hidden md:block px-3 py-2 text-[10px] tracking-[0.2em] uppercase text-[#161514]/50 font-medium">
            Menu Navigasi CMS
          </div>

          <div className="flex md:flex-col gap-1.5 md:gap-1 overflow-x-auto md:overflow-visible -mx-3 px-3 md:mx-0 md:px-0 pb-1 md:pb-0">
            {tabs.map((tab) => {
              const Icon = tab.icon;
              ...
              return (
                <button
                  ...
                  className={`shrink-0 md:w-full flex items-center justify-between gap-2 px-3.5 py-3 text-xs tracking-wider uppercase transition-all duration-150 cursor-pointer whitespace-nowrap ${
                    isActive
                      ? 'bg-[#161514] text-[#F7F5F0] font-medium'
                      : 'text-[#161514]/75 hover:bg-[#161514]/5'
                  }`}
                >
          ...
          <div className="hidden md:block pt-4 mt-4 border-t border-[#161514]/10 px-3 text-[11px] text-[#161514]/60 font-light leading-relaxed">
            <p>
        ...
        <main className="md:col-span-9 bg-[#F7F5F0] border border-[#161514]/15 p-4 sm:p-8 text-left space-y-8">
          ...
          {activeTab === 'spaces' && (
            <div className="space-y-8">
              <div>
                ...
                <p className="text-xs text-[#161514]/60 font-light mt-1">
                  Tambahkan foto sudut kafe, meja slow bar, atau lounge beserta deskripsi singkatnya. Jumlah foto tidak dibatasi — hanya terbatas kapasitas penyimpanan peramban.
                </p>
              </div>
          ...
          <div className="pt-6 border-t border-[#161514]/10 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
            ...
            <button
              onClick={handleSaveAll}
              className="flex items-center justify-center space-x-2 px-6 py-3 bg-[#161514] text-[#F7F5F0] text-xs uppercase tracking-wider font-semibold hover:bg-[#2A2724] cursor-pointer"
            >
